...
/// <item>this[i]: i-th D6 collection.</item>
/// <item>this[i,j,k,l,m,n,o]: element at the (i,j,k,l,m,n,o)-th position.</item>
/// <item>GetOrNone(i,j,k,l,m,n,o): returns Some of the element at the (i,j,k,l,m,n,o)-th position if indices are valid; None otherwise.</item>
/// <item>AsEnumerable(): returns the collection as IEnumerable; particularly useful for linq calls over the collection.</item>
/// </list>
/// 
/// </summary>
public class UniJaggedD7<T>
{
    // data
    internal readonly Func<int, int, int, int, int, int, int, T> Get;
    /// <summary>
    /// Length of the jagged collection in the first dimension.
    /// 
    /// <code>
    /// var array7 = new int[7] { 0, 1, 2, 3, 4, 5, 6 };
    ...
    /// UniJaggedD7&lt;int> jagged = new(array1);
    /// 
    ...
    /// UniJaggedD7&lt;int> jagged = new(array1);
    /// 
    /// Assert(jagged.Length7(1, 0, 3, 1, 0, 3) == 7);  // jagged[1][0][3][1][3] is array7, having a length of 7
    /// </code>
    /// </summary>
    public readonly Func<int, int, int, int, int, int, int> Length7;
    /// <summary>
    /// Safely gets Some of the element at the (i,j,k,l,m,n,o)-th position; returns None if the indices are invalid.
    /// 
    /// <code>
    /// var array7 = new int[7] { 0, 1, 2, 3, 4, 5, 6 };
    /// var array6 = new int[4][] { new int[1], new int[2], new int[5], array7 };
    ...
    /// UniJaggedD7&lt;int> jagged = new(array1);
    /// 
    /// Assert(jagged.GetOrNone(1, 0, 3, 1, 0, 3, 5) == Some(5));
    /// Assert(jagged.GetOrNone(1, 0, 3, 1, 0, 3, 7).IsNone);
    /// Assert(jagged.GetOrNone(4, 0, 0, 0, 0, 0, 0).IsNone);
    /// </code>
    /// 
    /// For other methods on the resulting optional, see <see cref="Opt{T}"/>.
    /// </summary>
    public readonly Func<int, int, int, int, int, int, int, Opt<T>> GetOrNone;
    /// <summary>
    ...
    /// </summary>
    public readonly Func<IEnumerable<IEnumerable<IEnumerable<IEnumerable<IEnumerable<IEnumerable<IEnumerable<T>>>>>>>> AsEnumerable;
    // data - constant
    /// <summary>
    ...
    // ctor
    internal UniJaggedD7(int length1, Func<int, int> length2, Func<int, int, int> length3, Func<int, int, int, int> length4, Func<int, int, int, int, int> length5, Func<int, int, int, int, int, int> length6, Func<int, int, int, int, int, int, int> length7, Func<int, int, int, int, int, int, int, T> get, Func<int, int, int, int, int, int, int, Opt<T>> getOrNone, Func<IEnumerable<IEnumerable<IEnumerable<IEnumerable<IEnumerable<IEnumerable<IEnumerable<T>>>>>>>> asEnumerable, Opt<T> underlyingConstantValue)
    {
        Length1 = () => length1;
        Length2 = length2;
        Length3 = length3;
    ...
    /// <summary>
    /// 7-dimensional jagged collection with optional lengths, which always yields the same constant value.
    /// 
    ...
    public UniJaggedD7(T constantValue, Opt<int> length1 = default, Opt<Func<int, int>> getLength2 = default,
        ...
        Opt<Func<int, int, int, int, int, int, int>> getLength7 = default)
    {
        ...
        Get = (_, _, _, _, _, _, _) => constantValue;
        GetOrNone = (_, _, _, _, _, _, _) => Some(constantValue);
        ...
        AsEnumerable = ()
            ...
            .Select(o => constantValue)))))));
        UnderlyingScalar = Some(constantValue);
    }
    /// <summary>
    /// 7-dimensional jagged collection with optional lengths, values of which are determined by the <paramref name="getValue"/> function.
    /// 
    ...
    /// <param name="getLength6">Optional function (i,j,k,l,m -> length) to get length of the (i,j,k,l,m)-th collection; when omitted will default to None which will yield to a length of int.MaxValue for any indices.</param>
    /// <param name="getLength7">Optional function (i,j,k,l,m,n -> length) to get length of the (i,j,k,l,m,n)-th collection; when omitted will default to None which will yield to a length of int.MaxValue for any indices.</param>
    public UniJaggedD7(Func<int, int, int, int, int, int, int, T> getValue, Opt<int> length1 = default, Opt<Func<int, int>> getLength2 = default,
        Opt<Func<int, int, int>> getLength3 = default, Opt<Func<int, int, int, int>> getLength4 = default,
        Opt<Func<int, int, int, int, int>> getLength5 = default, Opt<Func<int, int, int, int, int, int>> getLength6 = default,
        Opt<Func<int, int, int, int, int, int, int>> getLength7 = default)
    {
        ...
        Get = (i, j, k, l, m, n, o) => getValue(i, j, k, l, m, n, o);
        GetOrNone = (i, j, k, l, m, n, o) =>
        {
            if (i > -1 && i < len1())
            {
                if (j > -1 && j < len2(i))
                            ...
                            if (m > -1 && m < len5(i, j, k, l))
                            {
                                if (n > -1 && n < len6(i, j, k, l, m))
                                    if (o > -1 && o < len7(i, j, k, l, m, n))
                                        return Some(getValue(i, j, k, l, m, n, o));
                            }
                        }
                    }
                }
        ...
        AsEnumerable = ()
            ...
            .Select(m => Range(len6(i, j, k, l, m))
            .Select(n => Range(len7(i, j, k, l, m, n))
            .Select(o => getValue(i, j, k, l, m, n, o))))))));
        UnderlyingScalar = None<T>();
    }
    /// <summary>
    /// 7-dimensional jagged collection lengths and values of which are determined by the underlying <paramref name="array"/>.
    /// 
    ...
    public UniJaggedD7(T[][][][][][][] array)
    {
        ...
        Get = (i, j, k, l, m, n, o) => array[i][j][k][l][m][n][o];
        GetOrNone = (i, j, k, l, m, n, o) =>
        {
            if (i > -1 && i < len1())
            {
                    ...
                    if (k > -1 && k < len3(i, j))
                    {
                        if (l > -1 && l < len4(i, j, k))
                        {
                            if (m > -1 && m < len5(i, j, k, l))
                                if (n > -1 && n < len6(i, j, k, l, m))
                                    if (o > -1 && o < len7(i, j, k, l, m, n))
                                        return Some(array[i][j][k][l][m][n][o]);
                        }
                    }
                }
            }
    ...
    public UniJaggedD7(T[,,,,,,] array)
    {
        ...
        AsEnumerable = ()
                ...
                .Select(m => Range(len6(i, j, k, l, m))
                .Select(n => Range(len7(i, j, k, l, m, n))
                .Select(o => array[i, j, k, l, m, n, o])))))));
        UnderlyingScalar = None<T>();
    }
    /// <summary>
    /// 7-dimensional jagged collection lengths and values of which are determined by the underlying <paramref name="list"/>.
    /// 
    ...
    public UniJaggedD7(List<List<List<List<List<List<List<T>>>>>>> list)
    {
        int len1() => list.Count;
        ...
        Get = (i, j, k, l, m, n, o) => list[i][j][k][l][m][n][o];
        GetOrNone = (i, j, k, l, m, n, o) =>
        {
            if (i > -1 && i < len1())
            {
                    ...
                    if (k > -1 && k < len3(i, j))
                    {
                        if (l > -1 && l < len4(i, j, k))
                        {
                            if (m > -1 && m < len5(i, j, k, l))
                                if (n > -1 && n < len6(i, j, k, l, m))
                                    if (o > -1 && o < len7(i, j, k, l, m, n))
                                        return Some(list[i][j][k][l][m][n][o]);
                        }
                    }
                }
            }
    ...
    /// </summary>
    /// <param name="list">Underlying list of the unified jagged collection.</param>
    public UniJaggedD7(IList<IList<IList<IList<IList<IList<IList<T>>>>>>> list)
    {
        int len1() => list.Count;
        int len2(int i) => list[i].Count;
        int len3(int i, int j) => list[i][j].Count;
    ...
    /// <summary>
    /// 7-dimensional jagged collection lengths and values of which are determined by the underlying <paramref name="enumerable"/>.
    /// 
    /// <para>
    ...
    public UniJaggedD7(IEnumerable<IEnumerable<IEnumerable<IEnumerable<IEnumerable<IEnumerable<IEnumerable<T>>>>>>> enumerable)
    {
        ...
        Get = (i, j, k, l, m, n, o) => enumerable.ElementAt(i).ElementAt(j).ElementAt(k).ElementAt(l).ElementAt(m).ElementAt(n).ElementAt(o);
        GetOrNone = (i, j, k, l, m, n, o) =>
        {
            if (i > -1 && i < len1())
            {
                    ...
                    if (k > -1 && k < len3(i, j))
                    {
                        if (l > -1 && l < len4(i, j, k))
                        {
                            if (m > -1 && m < len5(i, j, k, l))
                                if (n > -1 && n < len6(i, j, k, l, m))
                                    if (o > -1 && o < len7(i, j, k, l, m, n))
                                        return Some(enumerable.ElementAt(i).ElementAt(j).ElementAt(k).ElementAt(l).ElementAt(m).ElementAt(n).ElementAt(o));
                        }
                    }
                }
            }
    ...
    // index
    /// <summary>
    /// Returns the <paramref name="i"/>-th D6 collection.
    /// <code>
    /// var array7 = new int[7] { 0, 1, 2, 3, 4, 5, 6 };
    /// var array6 = new int[4][] { new int[1], new int[2], new int[5], array7 };
    /// var array5 = new int[2][][] { array6, new int[5][] };
    ...
    /// Assert(jaggedI[0, 3, 1, 0, 3, 5] == jagged[1, 0, 3, 1, 0, 3, 5] == 5);
    /// </code>
    /// </summary>
    /// <param name="i">Index of the D6 collection to create.</param>
    public UniJaggedD6<T> this[int i]
    {
        get
        {
            var get = Get;
            ...
            return new(Length2(i), j => length3(i, j), (j, k) => length4(i, j, k), (j, k, l) => length5(i, j, k, l),
                (j, k, l, m) => length6(i, j, k, l, m), (j, k, l, m, n) => length7(i, j, k, l, m, n),
                (j, k, l, m, n, o) => get(i, j, k, l, m, n, o),
                (j, k, l, m, n, o) => getOrNone(i, j, k, l, m, n, o),
                () => asEnumerable().ElementAt(i),
                UnderlyingScalar);
        }
    }
    /// <summary>
    /// Directly returns the element at the (i,j,k,l,m,n,o)-th position.
    ...
    /// UniJaggedD7&lt;int> jagged = new(array1);
    /// 
    /// Assert(jagged[1, 0, 3, 1, 0, 3, 5] == 5);
    /// // var number = jagged[1, 0, 3, 1, 0, 3, 7]; // out-of-bounds, throws!
    /// // var number = jagged[4, 0, 0, 0, 0, 0, 0]; // out-of-bounds, throws!
    /// </code>
    /// </summary>
    ...
    public T this[int i, int j, int k, int l, int m, int n, int o]
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => Get(i, j, k, l, m, n, o);
    }
}
